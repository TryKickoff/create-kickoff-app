# Contributing to Create Kickoff App's E2E tests
...
These tests are run by **jest** and the environment is `test`, so that it resembles how a **Create Kickoff App** application is tested.
